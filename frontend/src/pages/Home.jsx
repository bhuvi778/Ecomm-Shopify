...
// Three.js canvas — lazy-loaded so the ~1 MB bundle is NEVER parsed on mobile Safari
const HomeScene3D = React.lazy(() => import("./HomeScene3D.jsx"));
    ...
    <>
      ...
      <div className="flex w-full overflow-hidden" style={{ height:"100svh", minHeight:"-webkit-fill-available" }}>
        ...
        <section ref={heroRef} className="flex-1 h-full relative overflow-hidden hero-bg home-hero-section">
          ...
          {/* THREE.JS CANVAS — lazy-loaded desktop-only chunk; never downloaded on mobile */}
